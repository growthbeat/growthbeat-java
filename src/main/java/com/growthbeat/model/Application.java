...
public class Application extends Model {
	...
	public static Application findById(String id, Context context) {
		return get(context, String.format("1/applications/%s", id), makeParams(context), Application.class);
	}
	...
	public static void deleteById(String id, Context context) {
		delete(context, String.format("1/applications/%s", id), makeParams(context));
	}
